...
// Single definition is in clay.c (the TU that has CLAY_IMPLEMENTATION). Needed so the symbol is exported when linking.
...
// Returns the current pointer (mouse/touch) position and interaction state.
